...
export function compileShader(gl, vert, frag)
{
    var vs = gl.createShader(gl.VERTEX_SHADER);
    gl.shaderSource(vs, vert);
    gl.compileShader(vs);
    if (!gl.getShaderParameter(vs, gl.COMPILE_STATUS)) {
        console.log("Vertex shader failed to compile, see console for log");
    ...
    if (!gl.getShaderParameter(fs, gl.COMPILE_STATUS)) {
        console.log("Fragment shader failed to compile, see console for log");
    ...
    if (!gl.getProgramParameter(program, gl.LINK_STATUS)) {
        console.log("Shader failed to link, see console for log");
